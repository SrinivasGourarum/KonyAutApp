...
function selectAmountCard(whatForm){
  ...
  }/* else if (whatForm === frmDepositLandingKA){
  	 depositAmountEntered = frmDepositLandingKA.amountTextField.text;
  	 frmDepositLandingKA.depositAmountEntered.text = "$" + depositAmountEntered;
