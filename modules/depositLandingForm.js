...
function saveFrontOfCheckImage() {
	...
	var base64Image = kony.convertToBase64(rawBytes);
  	...
  	frmNewDepositKA.frontCameraLabel.text = "Retake";
...
function saveBackOfCheckImage() {
    ...
    if (userAgent === "iPhone" || userAgent === "iPad"){
  	...
  	frmNewDepositKA.backCameraLabel.text = "Retake";
...
function resetDepositLandingCameras(){
  	...
  	frmNewDepositKA.frontCameraLabel.text = "Take Photo";
  	...
  	frmNewDepositKA.backCameraLabel.text = "Take Photo";
}
