...
var draw_qrcode = function(text, typeNumber, errorCorrectLevel) {
	create_qrcode(text, typeNumber, errorCorrectLevel);
};
...
var update_qrcode = function() {
	...
	//var text=eval(formName).tbxCode.text;
	//kony.print("text-------->"+text);
	//finalQRCode= create_qrcode(text);
	//var finalQRCode2=finalQRCode1.replace("\" width=\"82\" height=\"82\"/>", "");
	//kony.print("replacing one------->");
	//finalQRCode=finalQRCode2.replace("<img src=\"data:image/gif;base64,", "")
	//kony.print("replacing two------->");
	//kony.print("final code-------->"+finalQRCode);
	//eval(formName).imgCode.base64=finalQRCode;
	//eval(formName).imgCode.isVisible=true;
};
...
var qrcode = function() {
	...
	var qrcode = function(typeNumber, errorCorrectLevel) {
		...
		_this.createTableTag = function(cellSize, margin) {
			kony.print("Cell Size is 1------------->"+cellSize);
			cellSize = cellSize || 2;
		...
		_this.createImgTag = function(cellSize, margin) {
			kony.print("Cell Size is ------------->"+cellSize);
			cellSize = cellSize || 2;
			margin = (typeof margin == 'undefined')? cellSize * 4 : margin;
